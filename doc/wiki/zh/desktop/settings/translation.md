...
在“目标语言”下拉框选择译入语言。选项包括：简体中文、繁体中文、捷克语、荷兰语、英语、法语、德语、匈牙利语、意大利语、日语、韩语、波兰语、葡萄牙语（巴西）、罗马尼亚语、俄语、西班牙语、土耳其语、乌克兰语、越南语、阿拉伯语、波斯语、塞尔维亚语、克罗地亚语、泰语、印度尼西亚语、菲律宾语（他加禄语）。默认值：`CHS`。
