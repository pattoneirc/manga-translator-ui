...
“目标语言”下拉框位于“设置 → 翻译”，选择单个翻译请求的目标语言，当前提供 26 种语言：简体中文、繁体中文、捷克语、荷兰语、英语、法语、德语、匈牙利语、意大利语、日语、韩语、波兰语、葡萄牙语（巴西）、罗马尼亚语、俄语、西班牙语、土耳其语、乌克兰语、越南语、阿拉伯语、波斯语、塞尔维亚语、克罗地亚语、泰语、印度尼西亚语、菲律宾语（他加禄语）。显示值由界面语言文件生成，保存时反向映射为三字母代码。
